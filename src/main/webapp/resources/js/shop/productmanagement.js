$(function() {
	// 获取此店铺下的商品列表的URL
	var listUrl = '/o2o_war_exploded/shop/getproductlistbyshop?pageIndex=1&pageSize=999';
	// 商品下架URL
	var statusUrl = '/o2o_war_exploded/shop/modifyproduct';
	getList();
	/**
	 * 获取此店铺下的商品列表
	 * 
			...
			.on(
					...
					function(e) {
						...
						if (target.hasClass('edit')) {
							...
							window.location.href = '/o2o_war_exploded/shop/productoperation?productId='
