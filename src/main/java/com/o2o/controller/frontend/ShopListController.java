...
//				shopCategoryCondition.setParent(parent);
				shopCategoryList = shopCategoryService.getShopCategoryList(ShopCategory.builder().parentId(parentId).build());
			} catch (Exception e) {
			...
			try {
				...
				shopCategoryList = shopCategoryService.getShopCategoryList(ShopCategory.builder().id(0).build());
			} catch (Exception e) {
				modelMap.put("success", false);
				modelMap.put("errMsg", e.getMessage());
			}
